...
Deployed and verified against the account see [`Lab_1_3_DataLake_Documentation.txt`](./Lab_1_3_DataLake_Documentation.txt) for the actual resource ARNs/names, deployment history, and verification results.
